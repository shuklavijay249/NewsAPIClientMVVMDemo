...
import com.vijay.newsapiclient.databinding.FragmentNewsBinding
import com.vijay.newsapiclient.presentation.adapter.NewsAdapter
import com.vijay.newsapiclient.presentation.viewmodel.NewsViewModel
...
class NewsFragment : Fragment() {
    ...
    private fun viewNewsList() {
        ...
        viewModel.newsHeadLines.observe(viewLifecycleOwner,{response->
            when(response){
               is com.vijay.newsapiclient.data.util.Resource.Success->{
                ...
                is com.vijay.newsapiclient.data.util.Resource.Error->{
                   hideProgressBar()
                ...
                is com.vijay.newsapiclient.data.util.Resource.Loading->{
                    showProgressBar()
                }
